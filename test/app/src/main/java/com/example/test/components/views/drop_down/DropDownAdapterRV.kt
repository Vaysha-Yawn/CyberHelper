package com.example.test.components.views.drop_down
...
class DropDownAdapterRV(
    ...
    class TemplateHolder(view: View, private val onClick: WhenValueTo?, private val onDDClick: Select, private val check: CheckChoose?) :
    ...
    override fun onCreateViewHolder(
        ...
        return TemplateHolder(view, onClick, onDDClick, check)
    }
