...
class CharacterList_Skill : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.character_list__skill, container, false)
        ...
        mCharacterVM.characterList.observe(viewLifecycleOwner) { list ->
            list.forEach { character ->
                if (character.id == characterId) {
                    val listNameGroup = TemplateCharacter().characterLisToGroupParam[3]!!
