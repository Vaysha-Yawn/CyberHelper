...
class CharacterList_Armor : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.character_list__armor, container, false)
        ...
        mCharacterVM.characterList.observe(viewLifecycleOwner) { list ->
            list.forEach { character ->
                if (character.id == characterId) {
                    val listNameGroup = TemplateCharacter().characterLisToGroupParam[2]!!
