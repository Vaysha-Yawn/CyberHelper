...
import com.example.test.helpers.ParamStringAdapterRV
import com.example.test.viewModels.CharacterDAO
import com.example.test.viewModels.GameDAO

class CharacterList_About : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.character_list__about, container, false)
        ...
        mCharacterVM.characterList.observe(viewLifecycleOwner) { list ->
            list.forEach { character ->
                if (character.id == characterId) {
                    val listNameGroup = TemplateCharacter().characterLisToGroupParam[5]!!
